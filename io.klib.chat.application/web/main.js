...
(function() {
	...
	var MODULE = angular.module('io.klib.chat',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/io.klib.chat/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/io.klib.chat/main/htm/about.htm'});
